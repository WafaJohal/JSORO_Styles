...
\begin{figure}[h]
	%todo maybe use tizk to do this figure
	\centering
...
%\begin{itemize}[noitemsep,nolistsep]
%\item the \emph{role}: which corresponds to the social role for the companion robot.
%\item the \emph{entities involved}: corresponding to the number of robots involved and their competencies (role they can play).
%\item the \emph{situational inter-relation}: the listener, the speaker (one can also specify here the spatial position of the agents).
%\end{itemize}
...
Several features form the literature of body communication have been implemented and applied for the Body Kinect data \cite{Labourette}.
