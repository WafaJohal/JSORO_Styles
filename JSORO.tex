...
\item \textbf{Distance Covered}: 
\item \textbf{Hand Relationship}: 
\item \textbf{Shoulder Angle}: 
\item \textbf{Elbow Flexion}: aperture angle of the elbow joints
\item \textbf{Feet Relationship}: 
...
\section{Discussion}
In interviews, perception from parents

Many parents noticed auto and permissive ("shy and expressive")
